                    ...
                    <tbody>
                        ${this.filterParticipantes(data).map(participante => `
                            <tr>
                                ...
                                <td>${participante.data_inscricao ? this.dashboard.formatDate(participant.data_inscricao) : 'Pendente'}</td>
                                <td>${participante.data_confirmacao ? this.dashboard.formatDate(participant.data_confirmacao) : 'Pendente'}</td>
                                <td class="actions">
                    ...
                    const data = {
                     ...
                     try {
                      ...
                      const response = await this.dashboard.makeRequest(url, {
                       ...
                       if (response.ok) {
                           this.dashboard.showNotification(`Participante ${itemId ? 'atualizada' : 'adicionada'} com sucesso!`, 'success');
